...
public class Config {
    ...
    public static void addOrder(final Context context, String transactionId, String paymentMode) {
        ...
        pDialog.show();
        String req = "{\"res_id\":\"res007\",\"user_id\":\"" + userId + "\",\"cart_id\":\"" + MyCartList.cartistResponseData.getCartid() + "\",\"address\":\"" + ChoosePaymentMethod.address + "\",\"phone\":\"" + ChoosePaymentMethod.mobileNo + "\",\"paymentref\":\"" + transactionId + "\",\"paystatus\":\"" + "succeeded" + "\",\"total\":\"" + CartListAdapter.totalAmountPayable + "\",\"paymentmode\":\""+ paymentMode +"\"}";
        Volley_Request postRequest = new Volley_Request();
