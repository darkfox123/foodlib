...
public class Product {
    ...
    public Product(String productId, String productName, String status, String primaryimage, String description, String plimit, List<String> images, List<Variants> variants, List<Extra> extra){
