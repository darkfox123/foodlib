...
public class OrderVariants {
    ...
    public OrderVariants(String varientid, String variantname, String varquantity, String varprice, String product_id, String productname, String image, List<Extra> extra){
      this.varientid = varientid;
      this.variantname = variantname;
      this.varquantity = varquantity;
      this.varprice = varprice;
