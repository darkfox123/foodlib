...
public RestaurantDetailResponse(String name, String address, String description, String phone, String web, String lat, String lon, String time, String tax, String currency, String minorder, List<String> images, List<String> deliverycity){
    this.name = name;
