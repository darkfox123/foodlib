...
public class MyFirebaseInstanceIDService extends FirebaseInstanceIdService {
    ...
    private void sendRegistrationToServer(final String token) {
        ...
        String req = "{\"res_id\":\"res007\", \"accesstoken\":\""+  token + "\"}";
        Volley_Request postRequest = new Volley_Request();
        postRequest.createRequest(MyFirebaseInstanceIDService.this, getResources().getString(R.string.mJSONURL_pushaddr), "POST", "sendToken", req);

        /*
        Api.getClient().sendAccessToken("res007", token, new Callback<RegistrationResponse>() {
            @Override
