...
public class ProductExtra extends AppCompatActivity {
    ...
    public static void addCartResponse(String response){
        try {
            ...
            if (jObj.getString("success").equalsIgnoreCase("true")) {
                ...
                Config.getCartList(mContext, true);
    ...
    public static void showCustomAlertDialog(final Context context, String title, String msg, int type) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mActivity.overridePendingTransition(R.anim.slide_out_down, R.anim.slide_up_dialog);
