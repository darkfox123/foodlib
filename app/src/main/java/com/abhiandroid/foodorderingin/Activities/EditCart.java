...
public class EditCart extends AppCompatActivity {
    ...
    private void addToCart() {
        ...
        postRequest.createRequest(EditCart.this, getResources().getString(R.string.mJSONURL_addcart), "POST", "addcart", req);
        /*
        /*
        Api.getClient().addToCart("res007", product.getProductId(),
                MainActivity.userId,
                variantId,
                quantity + "",
    ...
    public static void addToCartResponse(String response){
        try {
            JSONObject jObj = new JSONObject(response);
            ps.dismiss();

            Log.d("addToCartResponse", jObj.getString("success") + "");
            if (jObj.getString("success").equalsIgnoreCase("true")) {
                ...
                alertDialog.setTitleText(jObj.getString("message"));
                alertDialog.setConfirmText("Verify Now");
                alertDialog.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                    @Override
                    public void onClick(SweetAlertDialog sweetAlertDialog) {
            ...
            Log.d("myTag", "error in json : ", ex);
        }
    }

    public static void showCustomAlertDialog(final Context context, String title, String msg, int type) {
